  ...
  if (contactForm) {
    ...
    function getFieldError(field) {
      ...
      if (field.minLength && field.minLength > 0) {
        if (!validators.minLength(value, field.minLength)) {
          return field.dataset.errorMinlength || 'Input is too short.';
        }
      }
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "StoryNest משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '84c6d988-f96e-464e-8ddd-333f343c324f',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '84c6d988-f96e-464e-8ddd-333f343c324f';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '84c6d988-f96e-464e-8ddd-333f343c324f';
